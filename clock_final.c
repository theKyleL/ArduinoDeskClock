...
* Two normally open momentary contact switches with pulldown resistors connect to pins 11 and 12.
*
*/
...
// clear the seconds when time is adjusted
void clearSec(void){
  seconds = 0;
}
...
void setup(){
  ...
  // at original value of 15624 clock runs too slow
  // 15000 too fast
  // 15300 too fast
  // 15450 too fast
  // 15500 too fast
  ...
  // 15600 too slow
  // decreasing to 15595
  OCR1A = 15595;// = (16*10^6) / (1*1024) - 1 (must be <65536) //originaly at 15624
  // turn on CTC mode
  TCCR1B |= (1 << WGM12);
